...
// Images
import SkillNestLogo from "../../assets/Logo/SkillNestLogo.png";
        ...
        <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
          ...
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
            <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0">
             <img src={SkillNestLogo} alt="SkillNest Logo" className="object-contain w-40" />
        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            <div className="flex ">
              ...
              <Link to='https://github.com/Saniya2701' target="__blank" className="text-white hover:underline mr-1"
              >
                Saniya Mane
              </Link>
            </div>
          ...
          <div className="flex items-center">
            <a href="https://www.linkedin.com/in/saniyamane/" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImLinkedin2 size={17} />
            </a>
            <a href="https://github.com/Saniya2701" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImGithub size={17} />
            </a>
          </div>
