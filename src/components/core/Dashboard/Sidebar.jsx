...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {
        openSideMenu &&
        <div className="max-sm:fixed sm:static max-sm:top-[3.5rem] max-sm:left-0 max-sm:w-[220px] z-[1000] flex h-[calc(100vh-3.5rem)] min-w-[220px] flex-col border-r-[1px] border-r-richblack-700 bg-richblack-800 py-10">
